 ...
 * @property Element_OphAuAnaestheticsatisfactionaudit_Notes_ReadyForDischarge $ready_for_discharge
 */

class Element_OphAuAnaestheticsatisfactionaudit_Notes extends BaseEventTypeElement
{
	public $service;
	...
	{
		return 'et_auophanaestheticsataudit_notes';
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'ready_for_discharge' => array(self::BELONGS_TO, 'Element_OphAuAnaestheticsatisfactionaudit_Notes_ReadyForDischarge', 'ready_for_discharge_id'),
		);
	}
