 ...
 */
 ...
 <script type="text/javascript">
	 $(document).ready(function() {
	 	scoreData = {
	 		'respiratory_rate' : <?php echo CJavaScript::encode(CHtml::listData(Element_OphOuAnaestheticsatisfactionaudit_VitalSigns_RespiratoryRate::model()->findAll(array('order'=> 'display_order asc')),'id','score')); ?>,
	 		'oxygen_saturation': <?php echo CJavaScript::encode(CHtml::listData(Element_OphOuAnaestheticsatisfactionaudit_VitalSigns_OxygenSaturation::model()->findAll(array('order'=> 'display_order asc')),'id','score')); ?>,
	 		'systolic': <?php echo CJavaScript::encode(CHtml::listData(Element_OphOuAnaestheticsatisfactionaudit_VitalSigns_Systolic::model()->findAll(array('order'=> 'display_order asc')),'id','score')); ?>,
	 		'body_temp': <?php echo CJavaScript::encode(CHtml::listData(Element_OphOuAnaestheticsatisfactionaudit_VitalSigns_BodyTemp::model()->findAll(array('order'=> 'display_order asc')),'id','score')); ?>,
	 		'heart_rate': <?php echo CJavaScript::encode(CHtml::listData(Element_OphOuAnaestheticsatisfactionaudit_VitalSigns_HeartRate::model()->findAll(array('order'=> 'display_order asc')),'id','score')); ?>,
	 		'conscious_lvl': <?php echo CJavaScript::encode(CHtml::listData(Element_OphOuAnaestheticsatisfactionaudit_VitalSigns_ConsciousLvl::model()->findAll(array('order'=> 'display_order asc')),'id','score')); ?>
	 	};
	 	calculateScore();
	 });
